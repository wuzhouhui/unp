 ...
 * =============================================================================
 *
 *       Filename:  sctp_displayevents.c
 *
 *    Description:  notification displaying utility. figure 23-4, page 492.
 *
 *        Version:  1.0
 *        Created:  04/06/2015 07:26:21 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
void print_notif(char *notify_buf)
{
	...
	case SCTP_PEER_ADDR_CHANGE:
		...
		printf("SCTP_PEER_ADDR_CHANGE: %s, addr = %s, assoc = 0x%x\n",
				str, Sock_ntop((SA *)&spc->spc_addr, 
				sizeof(spc->spc_addr)), (uint32_t)spc->spc_assoc_id);
		break;
