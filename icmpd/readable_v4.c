 ...
 * =============================================================================
 *
 *       Filename:  readable_v4.c
 *
 *    Description:  handling ICMPv4 packet received. figure 28-39,
 *		    page 618.
 *
 *        Version:  1.0
 *        Created:  04/17/2015 01:35:55 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
int readable_v4(void)
{
	...
	printf("%d bytes ICMPv4 from %s:", n, Sock_ntop_host((SA *)&from,
				len));
